...
public class DecodeEditEncodeTest {
     ...
     */
    void setParameters(int width, int height, int bitRate) {
     ...
     */
    void videoEditTest() throws IOException {
     ...
     */
    private void editVideoFile(VideoChunks inputData) throws IOException {
        ...
        try {
            ...
            String outputPath = new File(
                    ...
                    "imageToSurfaceToVideo.mp4").toString();
            muxer = new MediaMuxer(outputPath, MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);

            editVideoData(inputData, decoder, outputSurface, inputSurface, encoder, muxer);
        } finally {
